...
CAT_BLUE_TOP = (205, 240, 225, 255)
CAT_BLUE_MID = (70, 185, 140, 255)
CAT_BLUE_BOT = (30, 130, 95, 255)
CAT_BLUE_SIDE = (16, 90, 66, 255)
...
def draw_cat(size):
    ...
    for side in (-1, 1):
        ...
        # 外侧半（墨玉深林绿）：tip -> outer -> 沿弧 -> mid -> tip
    ...
    d.ellipse(face_box, fill=(246, 238, 218, 255))
